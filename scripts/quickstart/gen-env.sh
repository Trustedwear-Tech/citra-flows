...
echo ""
echo "REQUIRED before 'up': set ADMIN_EMAIL and ADMIN_PASSWORD in .env — your"
echo "sign-in credentials, seeded as super_admin in org ADMIN_ORG_ID. There are"
echo "no defaults; the stack refuses to start without them. (Or run"
echo "scripts/quickstart/wizard.sh, which asks.)"
